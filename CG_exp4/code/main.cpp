...
void init()
{
	...
	// 设置物体的旋转位移
	table->setTranslation(glm::vec3(0.0, 0.0, 0.0));
	table->setRotation(glm::vec3(270.0, 0.0, 0.0));
	...
	// 设置物体的旋转位移
	wawa->setTranslation(glm::vec3(0.0, 0.6, 0.0));
	wawa->setRotation(glm::vec3(270.0, 0.0, 0.0));
...
int main(int argc, char** argv)
{
	...
	// 配置窗口属性
	GLFWwindow* window = glfwCreateWindow(600, 600, "2020284022_吴洪涛_实验4", NULL, NULL);
	if (window == NULL)
	{
