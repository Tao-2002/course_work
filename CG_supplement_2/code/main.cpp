...
void display()
{
	...
	mstack.push(modelMatrix);
    // @TODO: 左大腿
	modelMatrix = glm::translate(modelMatrix, glm::vec3( -robot.LOWER_LEG_WIDTH-0.1, 0.0, 0.0));
	...
	// @TODO: 左小腿
	modelMatrix = glm::translate(modelMatrix, glm::vec3(-0.25*robot.LOWER_LEG_WIDTH, -robot.UPPER_LEG_HEIGHT, 0.0));
...
int main(int argc, char **argv)
{
	...
	// 配置窗口属性
	GLFWwindow* window = glfwCreateWindow(600, 600, "2020284022_吴洪涛_补充实验2", NULL, NULL);
	if (window == NULL)
	{
